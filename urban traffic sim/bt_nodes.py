...
############################### Leaf Nodes ##################################
class Check(Node):
    def __init__(self, check_function, vehicle, graph):
        self.check_function = check_function
        self.vehicle = vehicle
        self.graph = graph

    def execute(self):
        return self.check_function(self.vehicle, self.graph)
...
class Action(Node):
    def __init__(self, action_function, vehicle, graph):
        self.action_function = action_function
        self.vehicle = vehicle
        self.graph = graph

    def execute(self):
        return self.action_function(self.vehicle, self.graph)
